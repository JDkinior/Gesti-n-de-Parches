...
<div class="row g-4">
    <div class="col-12 col-md-6">
        <label for="name" class="form-label">
            <i class="fas fa-cube"></i> Nombre del Sistema
        </label>
    ...
    <div class="col-12 col-md-6">
        <label for="current_version" class="form-label">
            <i class="fas fa-code-branch"></i> Versión Actual
        </label>
    ...
    <div class="col-12 col-md-6">
        <label for="latest_version" class="form-label">
            <i class="fas fa-arrow-up"></i> Versión Objetivo
        </label>
    ...
    <div class="col-12 col-md-4">
        <label for="last_updated_at" class="form-label">
            <i class="fas fa-calendar-alt"></i> Última Actualización
        </label>
    ...
    <div class="col-12">
        <div class="form-check form-check-lg p-3 rounded-3 border border-secondary bg-dark text-light">
            ...
            <label class="form-check-label" for="is_documented">
                ...
                <small class="text-light d-block">Marca esta opción si tu organización mantiene documentación interna sobre las versiones instaladas.</small>
            </label>
        </div>
    </div>
    ...
    <div class="col-12">
        ...
        <textarea class="form-control" id="notes" name="notes" rows="4" maxlength="2000" placeholder="Añade información adicional sobre este sistema, cambios recientes, problemas conocidos, etc.">{{ old('notes', $system->notes ?? '') }}</textarea>
        <small class="text-light d-block mt-2"><i class="fas fa-info-circle"></i> Máximo 2000 caracteres</small>
